...
8. 支持 Quicker 操作：可以在 `hot-rule.txt` 中添加 Quicker 操作，客户端动态载入
...
- Quicker 操作热词请写到 `hot-rule.txt` 文件，每行一个，将触发关键词和 Quicker 操作 ID 以等号隔开，如 `代码 = fc190626-8d00-4562-85e3-34c0580f074f` ，则所有识别结果中的「代码」都会被触发 Quicker 操作「fc190626-8d00-4562-85e3-34c0580f074f」
...
4. 例如 `hot-rule.txt` 有热词「代码 = fc190626-8d00-4562-85e3-34c0580f074f」，则所有识别结果中的「代码」都会被触发 Quicker 操作「fc190626-8d00-4562-85e3-34c0580f074f」
...
Quicker 软件内需要先打开 WebSocket 服务，才能触发 Quicker 操作。关于 WebSocket 服务可以看官方的说明：[WebSocket 服务 - Quicker](https://getquicker.net/KC/Manual/Doc/websocketservice)。

如果在 `hot-rule.txt` 中定义了 Quicker 操作热词，客户端在识别到热词后，会触发对应的 Quicker 操作。
